...
export default class Index extends React.Component{
    ...
    render(){
        ...
        let runningWindow = running.map(app => (
            <Window moving={this.state.moving} changeMovingState={this.changeMovingState.bind(this)} focusWindow={this.focusWindow.bind(this)} winHideCtrl={this.winHideCtrl.bind(this)} willMax={this.state.willMax} WillMaxCtrl={this.WillMaxCtrl.bind(this)} closeWindow={this.closeWindow.bind(this)} key={app.detail.appId} appItem={app} />
        ))
